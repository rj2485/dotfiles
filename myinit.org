...
** org-capture setup
   ...
   #+RESULTS:
   | a | Calendar Items | entry | (file+headline ~/Dropbox/src/orgfiles/cal.org Calendar Unfiled) | * %?\n:PROPERTIES:\n\n:END:\nDEADLINE: %^T \n %i\n      |          |   |
   | n | Note           | entry | (file+headline ~/Dropbox/src/orgfiles/notes.org Notes)          | * %?\n%T                                                |          |   |
   | l | Link           | entry | (file+headline ~/Dropbox/src/orgfiles/links.org Links)          | * %? %^L %^g \n%T                                       | :prepend | t |
   | t | To Do Item     | entry | (file+headline ~/Dropbox/src/orgfiles/i.org To Do Items)        | * TODO %?\n:PROPERTIES:\n\n:END:\nDEADLINE: %^T \n %i\n | :prepend | t |
   | j | Journal        | entry | (file+datetree ~/Dropbox/src/orgfiles/journal.org)              | * %?\nEntered on %U\n  %i\n  %a                         |          |   |
